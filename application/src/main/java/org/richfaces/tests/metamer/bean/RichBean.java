...
public class RichBean implements Serializable {
    ...
    private Map<String, String> primeComponents;
    ...
    private void createComponentsMap() {
        ...
        primeComponents = new TreeMap<String, String>();
        ...
        primeComponents.put("pAccordionPanel", "Prime Accordion Panel");
        primeComponents.put("pAjaxStatus", "Prime Ajax Status");
        primeComponents.put("pAutoComplete", "Prime AutoComplete");
        primeComponents.put("pBarChart", "Prime Bar Chart");
        primeComponents.put("pBreadCrumb", "Prime BreadCrumb");
        primeComponents.put("pCalendar", "Prime Calendar");
        primeComponents.put("pCaptcha", "Prime Captcha");
        primeComponents.put("pCarousel", "Prime Carousel");
        primeComponents.put("pColorPicker", "Prime Color Picker");
        primeComponents.put("pColumnChart", "Prime Column Chart");
        primeComponents.put("pCommandButton", "Prime Command Button");
        primeComponents.put("pCommandLink", "Prime Command Link");
        primeComponents.put("pConfirmDialog", "Prime Confirm Dialog");
        primeComponents.put("pContextMenu", "Prime Context Menu");
        primeComponents.put("pDataExporter", "Prime Data Exporter");
        primeComponents.put("pDataGrid", "Prime Data Grid");
        ...
        primeComponents.put("pPieChart", "Prime Pie Chart");
        primeComponents.put("pProgressBar", "Prime Progress Bar");
        primeComponents.put("pPush", "Prime Push");
        primeComponents.put("pSlider", "Prime Slider");
        primeComponents.put("pSpinner", "Prime Spinner");
        primeComponents.put("pStackedBarChart", "Prime Stacked Bar Chart");
        primeComponents.put("pStackedColumnChart", "Prime Stacked Column Chart");
        primeComponents.put("pTabView", "Prime Tab View");
        primeComponents.put("pTree", "Prime Tree");
