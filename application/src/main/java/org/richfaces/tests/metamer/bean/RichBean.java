...
public class RichBean implements Serializable {
    ...
    private Map<String, String> iceComponents;
    ...
    private void createComponentsMap() {
        ...
        iceComponents = new TreeMap<String, String>();
        ...
        iceComponents.put("icePanelDivider", "ICE Panel Divider");
        iceComponents.put("icePanelPopup", "ICE Panel Popup");
        iceComponents.put("icePanelStack", "ICE Panel Stack");
        iceComponents.put("icePanelTabSet", "ICE Panel Tab Set");
    ...
    public Map<String, String> getIceComponents() {
        return iceComponents;
    }

    public Object[] getIceComponentsList() {
        return iceComponents.keySet().toArray();
    }
